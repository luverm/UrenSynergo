...
export default function UrenOverzicht() {
  ...
  const fetchEntries = useCallback(async () => {
    setLoading(true);
    setError(null);
    console.log("📥 Fetching entries for period:", period);
    try {
      ...
      <div style={{ maxWidth: 520, margin: "0 auto" }}>
        ...
        {error && (
          <div style={{
            ...
            background: "rgba(232,44,107,0.1)", border: "1px solid rgba(232,44,107,0.2)",
            color: "#E82C6B", fontSize: 14, fontWeight: 500,
