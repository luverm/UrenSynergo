          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.path === "/" && focus.active && !focus.isPaused && (
                  <span style={{ width: 6, height: 6, borderRadius: 99, background: "#4CAF7D", animation: "pulse 2s ease-in-out infinite", flexShrink: 0 }} title="Focus timer loopt" />
                )}
                {item.path === "/" && focus.active && focus.isPaused && (
                  <span style={{ width: 6, height: 6, borderRadius: 99, background: "#6E6E72", flexShrink: 0 }} title="Focus timer gepauzeerd" />
                )}
